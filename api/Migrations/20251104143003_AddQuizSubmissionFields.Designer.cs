...
namespace api.Migrations
{
    ...
    [Migration("20251104143003_AddQuizSubmissionFields")]
    partial class AddQuizSubmissionFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Quiz", b =>
                {
                    b.HasOne("api.Models.AuthUser", "Creator")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("api.Models.QuizSubmission", b =>
                {
                    ...
                    b.HasOne("api.Models.AuthUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
